        ...
        public string InserirDadosBD(DAOEstoqueRolosList daoEstoqueRolosList)
        {
            ...
            try
            {
                ...
                foreach (DataRow linha in dataTableEstoqueRolosList.Rows)
                {
                    ...
                    daoEstoqueRolos.CodigoRolo = Convert.ToInt32(linha["CodigoRolo"].ToString());
                    daoEstoqueRolos.RoloOrigem = Convert.ToInt32(linha["RoloOrigem"].ToString());
                    daoEstoqueRolos.Sit = Convert.ToInt32(linha["Sit"].ToString());
                    ...
                    daoEstoqueRolos.Op = Convert.ToInt32(linha["Op"].ToString());
                    ...
                    daoEstoqueRolos.Operador = Convert.ToInt32(linha["Operador"].ToString());
                    daoEstoqueRolos.NomeOperador = linha["NomeOperador"].ToString();
                    daoEstoqueRolos.Nuance = linha["Nuance"].ToString();
                    daoEstoqueRolos.Qualidade = Convert.ToInt32(linha["Qualidade"].ToString());
                    ...
                    daoEstoqueRolos.Turno = Convert.ToInt32(linha["Turno"].ToString());
                    daoEstoqueRolos.Pontuacao = linha["Pontuacao"].ToString();
                    daoEstoqueRolos.Pedido = Convert.ToInt32(linha["Pedido"].ToString());
                    daoEstoqueRolos.SEqPedido = linha["SEqPedido"].ToString();
                    daoEstoqueRolos.Nf = linha["Nf"].ToString();
                    daoEstoqueRolos.Serie = Convert.ToInt32(linha["Serie"].ToString());
                    ...
                    daoEstoqueRolos.EnderecoRolo = Convert.ToInt32(linha["EnderecoRolo"].ToString());
                    daoEstoqueRolos.CodigoTecelao = linha["CodigoTecelao"].ToString();
                    daoEstoqueRolos.Romaneio = Convert.ToInt32(linha["Romaneio"].ToString());
                    ...
                    dalMySQL.AdicionaParametros("@InicioProdução", daoEstoqueRolos.InicioProdução);
                    dalMySQL.AdicionaParametros("@TerminoProdução", daoEstoqueRolos.TerminoProdução);
                    ...
                    dalMySQL.AdicionaParametros("@DataInsercao", daoEstoqueRolos.DataInsercao);
