        ...
        public DAONotasFiscaisList LerCsv(string path)
        {
            ...
            while ((linha = csv.ReadLine()) != null)
            {
                ...
                if (index > 1)
                {
                    ...
                    daoNotasFiscais.CodigoContabil = campo[32].ToString();
                    daoNotasFiscais.BaseIpi = campo[33].ToString();
                    daoNotasFiscais.PercIpi = campo[34].ToString();
                    daoNotasFiscais.ValorIpi = Convert.ToDecimal[35].ToString();
                    daoNotasFiscais.CvfIpi = campo[36].ToString();
                    daoNotasFiscais.BaseIcms = campo[37].ToString();
                    daoNotasFiscais.ValorIcms = Convert.ToDecimal[38].ToString();
                    daoNotasFiscais.CvfIcms = campo[39].ToString();
                    daoNotasFiscais.Procedencia = campo[40].ToString();
                    daoNotasFiscais.BaseDiferencia = campo[41].ToString();
                    daoNotasFiscais.CvfPis = campo[42].ToString();
                    daoNotasFiscais.CvfConfins = campo[43].ToString();
                    daoNotasFiscais.PercConfins = campo[44].ToString();
                    daoNotasFiscais.BasePisCofins = campo[45].ToString();
                    daoNotasFiscais.ValorPis = Convert.ToDecimal[46].ToString();
                    daoNotasFiscais.ValorCofins = Convert.ToDecimal[47].ToString();
                    daoNotasFiscais.PercSubtituicao = campo[48].ToString();
                    daoNotasFiscais.BaseSubtituicao = campo[49].ToString();
                    daoNotasFiscais.ValorSubtituicao = Convert.ToDecimal[50].ToString();
                    daoNotasFiscais.Projeto = campo[51].ToString();
