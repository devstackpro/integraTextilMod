        ...
        public DAOSaldoEstoqueList LerCsv(string path)
        {
            ...
            while ((linha = csv.ReadLine()) != null)
            {
                ...
                if (index > 1)
                {
                    ...
                    daoSaldoEstoque.Linha = Convert.ToDecimal(campo[19].ToString());
                    daoSaldoEstoque.Art = campo[20].ToString();
                    daoSaldoEstoque.Cota = Convert.ToDecimal[21].ToString();
                    ...
                    daoSaldoEstoque.ValorMedioEstoque = Convert.ToDecimal[41].ToString();
                    daoSaldoEstoque.ValorUltimaCopmpra = Convert.ToDecimal[42].ToString();
                    daoSaldoEstoque.Custo = Convert.ToDecimal[43].ToString();
                    daoSaldoEstoque.CustoInformado = Convert.ToDecimal[44].ToString();
                    ...
                    daoSaldoEstoque.PesoLiquido = Convert.ToDecimal[48].ToString();
                    daoSaldoEstoque.PesoRolo = Convert.ToDecimal[49].ToString();
                    daoSaldoEstoque.PesoMinRolo = Convert.ToDecimal[50].ToString();
                    ...
                    daoSaldoEstoque.QtEstqInicioMes = Convert.ToDecimal[60].ToString();
                    daoSaldoEstoque.QtEstqFinalMes = Convert.ToDecimal[61].ToString();
                    daoSaldoEstoque.UltimaEntrada = Convert.ToDateTime[62].ToString();
                    daoSaldoEstoque.UltimaSaida = Convert.ToDateTime[63].ToString();
                    daoSaldoEstoque.QtSugerida = Convert.ToDecimal[64].ToString();
                    daoSaldoEstoque.QtEmpenhada = Convert.ToDecimal[65].ToString(); 
        ...
        public string InserirDadosBD(DAOSaldoEstoqueList daoSaldoEstoqueList)
        {
            ...
            try
            {
                ...
                foreach (DataRow linha in dataTableSaldoEstoqueList.Rows)
                {
                    ...
                    daoSaldoEstoque.Altp  = Convert.ToDecimal(linha["Altp "].ToString());
