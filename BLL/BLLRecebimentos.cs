        ...
        public DAORecebimentosList LerCsv(string path)
        {
            ...
            while ((linha = csv.ReadLine()) != null)
            {
                ...
                if (index > 1)
                {
                    ...
                    daoRecebimentos.VencOriginal = Convert.ToDateTime(campo[6].ToString());
                    daoRecebimentos.Vencimento = Convert.ToDateTime(campo[7].ToString());
                    ...
                    daoRecebimentos.PercComissao = campo[16].ToString();
                    ...
                    daoRecebimentos.CodigoContabil = Convert.ToDecimal(campo[47].ToString());
                    daoRecebimentos.ValorMoeda = campo[48].ToString();
                    ...
                    daoRecebimentos.DataRcnto = Convert.ToDateTime(campo[59].ToString());
                    daoRecebimentos.DataCredito = Convert.ToDateTime(campo[60].ToString());
                    ...
                    daoRecebimentos.Atraso = campo[73].ToString();
        ...
        public string InserirDadosBD(DAORecebimentosList daoRecebimentosList)
        {
            ...
            try
            {
                ...
                foreach (DataRow linha in dataTableRecebimentosList.Rows)
                {
                    ...
                    daoRecebimentos.VencOriginal = Convert.ToDateTime(linha["VencOriginal"].ToString());
                    daoRecebimentos.Vencimento = Convert.ToDateTime(linha["Vencimento"].ToString());
                    ...
                    daoRecebimentos.PercComissao = linha["PercComissao"].ToString();
                    ...
                    daoRecebimentos.DataRcnto = Convert.ToDateTime(linha["DataRcnto"].ToString());
                    daoRecebimentos.DataCredito = Convert.ToDateTime(linha["DataCredito"].ToString());
                    ...
                    dalMySQL.AdicionaParametros("@Col", daoRecebimentos.Col);
